  ...
  return (
    <div className="flex h-full min-h-0 flex-col gap-3 p-4 xl:p-5">
      <div className="glass-panel rounded-xl px-4 py-3">
        ...
        {cursorText && <div className="mt-1 text-base text-text-muted">{cursorText}</div>}
      </div>
      <div className="glass-panel flex flex-shrink-0 flex-wrap items-center gap-2 rounded-xl px-3 py-2">
        {tabs.map((tab) => (
          <button
            ...
            className={`rounded-full border px-3 py-1.5 text-[12px] font-semibold uppercase tracking-[0.16em] ${
