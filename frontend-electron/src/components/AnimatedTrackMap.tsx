...
export function AnimatedTrackMap({
  ...
  // Debug: log when we have car displayPositions
  useEffect(() => {
    console.log('[AnimatedTrackMap] resolvedCars:', resolvedCars.length, 
      'dotPositions size:', dotPositions.size,
      'trackData:', trackData ? 'loaded' : 'null')
  }, [resolvedCars, dotPositions, trackData])
