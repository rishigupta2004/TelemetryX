            ...
            <div className="space-y-3">
              <div className="flex flex-wrap items-start gap-3 rounded-xl border border-white/10 bg-black/20 p-3">
                {selectedTeam.teamImage || sessionImages.byTeam.get(selectedTeam.teamName) ? (
                  ...
                  <div className="flex h-24 w-24 items-center justify-center rounded-lg border border-white/10 bg-black/40 text-xl font-semibold text-white" style={{ borderColor: teamColorByName.get(selectedTeam.teamName) || '#2a3340' }}>
