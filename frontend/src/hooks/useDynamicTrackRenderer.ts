...
export const useDynamicTrackRenderer = (
  ...
  const render = useCallback((timestamp: number) => {
    ...
    if (currentFlags.isRedFlag) {
      ...
      redGrad.addColorStop(0, 'rgba(255, 30, 30, 0.22)')
      redGrad.addColorStop(1, 'rgba(255, 0, 0, 0.08)')
      drawPath(ctx, trackData.points, redGrad, 14, [], 'rgba(255, 0, 0, 0.55)', 10)
      ...
      scGrad.addColorStop(0, 'rgba(255, 165, 0, 0.2)')
      scGrad.addColorStop(1, 'rgba(255, 140, 0, 0.06)')
      drawPath(ctx, trackData.points, scGrad, 12, [], 'rgba(255, 165, 0, 0.55)', 8)
      ...
      vscGrad.addColorStop(0, 'rgba(255, 220, 0, 0.18)')
      vscGrad.addColorStop(1, 'rgba(255, 200, 0, 0.06)')
      drawPath(ctx, trackData.points, vscGrad, 10, [], 'rgba(255, 220, 0, 0.52)', 7)
    }
